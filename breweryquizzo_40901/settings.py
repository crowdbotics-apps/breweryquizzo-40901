"""
Django settings for breweryquizzo_40901 project.
...
ROOT_URLCONF = 'breweryquizzo_40901.urls'
...
WSGI_APPLICATION = 'breweryquizzo_40901.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "breweryquizzo_40901 API",
    "DESCRIPTION": "API documentation for breweryquizzo_40901 App",
    "VERSION": "v1",
}
